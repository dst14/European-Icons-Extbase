 ...
 */
class GroesseninformationenTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setStandardgroessenForStringSetsStandardgroessen() { 
		$this->fixture->setStandardgroessen('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getStandardgroessen()
		);
	}
