 ...
 */
class BeschnittinformationTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	...
	public function setBeschnittForStringSetsBeschnitt() { 
		$this->fixture->setBeschnitt('Conceived at T3CON10');

		$this->assertSame(
			'Conceived at T3CON10',
			$this->fixture->getBeschnitt()
		);
	}
